  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: SingleChildScrollView(
        child: BlocConsumer<InvestOptionBloc, InvestOptionState>(
                  ...
                  Padding(
                    ...
                    child: CustomButton(
                        onPressed: () async {
                          ...
                          print("outside if before payment");
                          await PaymentManager.makePayment(20, "USD");
                          print("outside if after payment");

                          if (storeId != 0) {
                            //TODO get.it mostly i don't need to did because it done
                            print("inside if before request");
                            print("$storeId");
                            print(
                                "\n *****************************************************");
                            context.read<InvestOptionBloc>().add(
                                InvestStoreEvent(
                                    storeId: storeId!,
