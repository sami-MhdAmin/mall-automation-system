...
class StoreForProductModel {
  ...
  factory StoreForProductModel.fromJson(Map<String, dynamic> json) => _$StoreForProductModelFromJson(json);
...
class CategoryDataModel {
  ...
  final List<dynamic> discount; // Change this type if there's a specific structure
