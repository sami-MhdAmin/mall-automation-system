...
class investorBillsModel {
  final List<investorStoreBillsDataModels>? data;
...
class investorStoreBillsDataModels {
  ...
  factory investorStoreBillsDataModels.fromJson(Map<String, dynamic> json) =>
      _$investorStoreBillsDataModelsFromJson(json);
  Map<String, dynamic> toJson() => _$investorStoreBillsDataModelsToJson(this);
}
